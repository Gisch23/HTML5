...
EPIC_MONO=""
if [ -f "X:\Programm Files (x86)\UE_4.22\Engine\Build\BatchFiles\Mac\SetupMono.sh" ]; then
    pushd "X:\Programm Files (x86)\UE_4.22\Engine\Build\BatchFiles\Mac"
	source SetupMono.sh
    popd
else
	EPIC_MONO="NOTE: It seems this $0 was built from another platform and copied here.\nNOTE: Was expecting to setup mono via: "'X:\Programm Files (x86)\UE_4.22\Engine\Build\BatchFiles\Mac\SetupMono.sh';
fi
